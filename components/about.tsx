...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"user","title":"뽀라돌","period":"1986","description":"전북 군산시 출생"},{"icon":"briefcase","title":"익산지방국토관리청 도로교통정보센터","period":"2024","description":"정보통신 초급"},{"icon":"lightbulb","title":"해외선물 ","period":"2021","description":"배우는 중"}],
    skills: [{"icon":"palette","title":"편집디자인","description":"컴퓨터 그래픽스 자격증"},{"icon":"heart","title":"해외선물","description":"해외선물 4년차 "},{"icon":"cpu","title":"AI","description":"현재 열심히 배우는중"}],
    storyTitle: "나의 이야기",
